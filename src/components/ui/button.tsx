  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-surface text-text-primary border border-border hover:bg-surface/80 hover:border-primary/30",
        outline:
        ...
        accent:
          "bg-accent text-background font-semibold hover:bg-accent-light shadow-lg shadow-accent/25",
        gradient:
          "bg-gradient-to-r from-primary to-accent text-white font-semibold shadow-lg shadow-primary/25 hover:shadow-primary/40 hover:-translate-y-0.5",
      },
      size: {
